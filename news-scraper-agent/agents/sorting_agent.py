...
class SortingAgent:
    ...
    def __request_sort(
        ...
        self.logger.info(f"[{self.site.name}] Sorting starting with {len(filtering_result)} articles.")
        ...
        self.logger.info(f"[{self.site.name}] Sorting finished. Top 3 selected.")
